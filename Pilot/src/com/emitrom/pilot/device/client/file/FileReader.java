...
public class FileReader extends JsObject {
    ...
    public native void readAsDataUrl(File file)/*-{
		var peer = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		peer
				.readAsDataUrl(file.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void readAsText(File file)/*-{
		var peer = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		peer
				.readAsText(file.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void readAsBinaryString(DirectoryEntry file)/*-{
        var peer = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
        peer
            .readAsBinaryString(file.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void readAsArrayBuffer(DirectoryEntry file)/*-{
        var peer = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
        peer
            .readAsArrayBuffer(file.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    }-*/;
