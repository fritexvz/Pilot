...
public class PushWooshBlackBerry implements Plugin {
	 ...
	 */
	public void setSimChangeHandler(
			PushWooshBlackBerrySimChangeHandler simChangeHandler) {
	...
	public void setRegisterCallback(
			PushWooshBlackBerryRegisterCallback registerCallback) {
	...
	/**
	 * Get the URL of the file that needs to be called upon wake-up
	 * from data
	 * @return
	 */
    ...
    /**
     * Registers to the BlackBerry push service, then after that
     * registers to the PushWoosh push service
     */
    public native void onDeviceReady() /*-{
    	var opts = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.packBisPushObject()();
    	var onData = function(obj) {
    			var rec = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getDataHandler()();
    			rec.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerryDataHandler.onDataReceived(com.google.gwt.core.client.JavaScriptObject;)(obj);
    		};
    	var onRegister = function(status) {
    		var callback = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getRegisterCallback()();
			if (status == 0) {
				this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.register()();
				callback.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerryRegisterCallback.onSuccess()();
			} else {
				callback.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerryRegisterCallback.onError(int;)(status);
			}
		};
		var onSimChange = function() {
			var cb = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getSimChangeHandler()();
			cb.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerrySimChangeHandler.onSimChange()();
		};
    	blackberry.push.openBISPushListener(opts, onData, onRegister, onSimChange);
    }-*/;
	...
	private final native JavaScriptObject packBisPushObject() /*-{
		var port = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getPort()();
		var appId = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getAppId()();
		var serverUrl = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getBbServerUrl()();
		var wakeupPage = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getWakeupUrl()();
		var max = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getQueueMax()();
		var ret = {
			port: port,
			appId: appId,
			serverUrl: serverUrl,
	...
	private final native String getPushWooshRegisterPayload() /*-{
		var appCode = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getAppId()();
		var token = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getToken()();
		var lang = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getLanguage()();
		var hwid = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getHWID()();
		var tz = this.@com.emitrom.pilot.device.client.plugins.blackberry.pushwoosh.PushWooshBlackBerry.getTimezoneOffset()();
		var devicetype = 2;
		var params = {
			request : {
				application: appCode,
