...
public class Contact extends JsObject {
    ...
    public native void remove(ContactRemoveHandler callBack)/*-{
		...
		peer
				.remove(
						$entry(function() {
							callBack.@com.emitrom.pilot.device.client.core.handlers.contacts.ContactRemoveHandler::onSuccess()();
						}),
						$entry(function(error) {
							...
							callBack.@com.emitrom.pilot.device.client.core.handlers.contacts.ContactRemoveHandler::onError(Lcom/emitrom/pilot/device/client/contacts/ContactError;)(errorObject);
						}));
    }-*/;
		...
		peer
				.save(
						$entry(function(contact) {
							var contactObject = @com.emitrom.pilot.device.client.contacts.Contact::new(Lcom/google/gwt/core/client/JavaScriptObject;)(contact);
							callBack.@com.emitrom.pilot.device.client.core.handlers.contacts.ContactSaveHandler::onSuccess(Lcom/emitrom/pilot/device/client/contacts/Contact;)(contactObject);
						}),
						$entry(function(error) {
							var errorObject = @com.emitrom.pilot.device.client.contacts.ContactError::new(Lcom/google/gwt/core/client/JavaScriptObject;)(error);
							callBack.@com.emitrom.pilot.device.client.core.handlers.contacts.ContactSaveHandler::onError(Lcom/emitrom/pilot/device/client/contacts/ContactError;)(errorObject);
						}));
    }-*/;
