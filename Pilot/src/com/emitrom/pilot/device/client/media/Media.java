...
import com.emitrom.pilot.device.client.core.handlers.media.MediaHandler;
import com.emitrom.pilot.device.client.core.handlers.media.MediaPositionHandler;
import com.emitrom.pilot.device.client.core.handlers.media.MediaStatusHandler;
...
public class Media extends Module {
    ...
    public native void getCurrentPosition(MediaPositionHandler handler)/*-{
		...
		peer
				.getCurrentPosition(
						$entry(function() {
							handler.@com.emitrom.pilot.device.client.core.handlers.media.MediaPositionHandler::onSuccess()();
						}),
						$entry(function(error) {
							var errorObject = @com.emitrom.pilot.device.client.media.MediaError::new(Lcom/google/gwt/core/client/JavaScriptObject;)(error);
							handler.@com.emitrom.pilot.device.client.core.handlers.media.MediaPositionHandler::onError(Lcom/emitrom/pilot/device/client/media/MediaError;)(errorObject);
						}));
    ...
    private native JavaScriptObject create(String src, MediaHandler handler)/*-{
		var media = new $wnd.Media(
				src,
				$entry(function() {
					handler.@com.emitrom.pilot.device.client.core.handlers.media.MediaHandler::onSuccess()();
				}),
				$entry(function(error) {
					var errorObject = @com.emitrom.pilot.device.client.media.MediaError::new(Lcom/google/gwt/core/client/JavaScriptObject;)(error);
					handler.@com.emitrom.pilot.device.client.core.handlers.media.MediaHandler::onError(Lcom/emitrom/pilot/device/client/media/MediaError;)(errorObject);
				}));
		return media
    }-*/;
    ...
    private native JavaScriptObject create(String src, MediaHandler handler, MediaStatusHandler statusHandler)/*-{
        var media = new $wnd.Media(
                ...
                $entry(function(status) {
                    var statusObject = @com.emitrom.pilot.device.client.media.MediaStatus::new(Lcom/google/gwt/core/client/JavaScriptObject;)(status);
                    statusHandler.@com.emitrom.pilot.device.client.core.handlers.media.MediaStatusHandler::onStatusUpdate(Lcom/emitrom/pilot/device/client/media/MediaStatus;)(statusObject);
                }));
        return media
    }-*/;
