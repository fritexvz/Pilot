...
public class Device extends Module {
    ...
    public String getName() {
        return JsoHelper.getAttribute(jsObj, Attributes.NAME.getValue());
    }
    ...
    public String getCordovaVersion() {
        return JsoHelper.getAttribute(jsObj, Attributes.CORDOVA.getValue());
    }
    ...
    public String getPlatform() {
        return JsoHelper.getAttribute(jsObj, Attributes.PLATFORM.getValue());
    }
    ...
    public String getUuId() {
        return JsoHelper.getAttribute(jsObj, Attributes.UUID.getValue());
    }
     ...
     */
    public static void addDeviceReadyEventHandler(DeviceReadyEventHandler callback) {
     ...
     *            callback function to call when event fires
     */
    public static void addBatteryCriticalEventHandler(BatteryCriticalEventHandler callback) {
     ...
     *            callback function to call when event fires
     */
    public static void addBatteryStatusEventHandler(BatteryStatusEventHandler callback) {
     ...
     *            callback function to call when event fires
     */
    public static void addSearchButtonEventHandler(SearchButtonEventHandler callback) {
     ...
     *            callback function to call when event fires
     */
    public static void addStartCallButtonEventHandler(StartCallButtonEventHandler callback) {
     ...
     *            callback function to call when event fires
     */
    public static void addEndCallButtonEventHandler(EndCallButtonEventHandler callback) {
        addEventListener(DeviceEvent.START_CALL_BUTTON.getValue(), callback);
    }
     ...
     *            callback function to call when event fires
     */
    public static void addVolumeDownButtonEventHandler(VolumeDownButtonEventHandler callback) {
     ...
     *            callback function to call when event fires
     */
    public static void addVolumeUpButtonEventHandler(VolumeUpButtonEventHandler callback) {
     ...
     * @param callback
     */
    public static void alert(String title, String message, String buttonLabels, Function callback) {
