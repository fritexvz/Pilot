...
public abstract class JsObject {
    ...
    public native String[] getProperties() /*-{
		var jsObj = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		return @com.emitrom.pilot.util.client.core.JsoHelper::getProperties(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj);
    }-*/;
