...
public class MarkerImage extends JsObject {
    ...
    public final native void setAnchor(Point value)/*-{
		var jso = this.@com.pilot.shared.client.JsObject::getJsObj()();
		this.anchor = value.@com.pilot.shared.client.JsObject::getJsObj()();
    }-*/;
    ...
    public final native void setOrigin(Point value)/*-{
		var jso = this.@com.pilot.shared.client.JsObject::getJsObj()();
		this.origin = value.@com.pilot.shared.client.JsObject::getJsObj()();
    }-*/;
    ...
    public final native void setScaledSize(Size value)/*-{
		var jso = this.@com.pilot.shared.client.JsObject::getJsObj()();
		this.scaledSize = value.@com.pilot.shared.client.JsObject::getJsObj()();
    }-*/;
    ...
    public final native void setSize(Size value)/*-{
		var jso = this.@com.pilot.shared.client.JsObject::getJsObj()();
		this.size = value.@com.pilot.shared.client.JsObject::getJsObj()();
    }-*/;
