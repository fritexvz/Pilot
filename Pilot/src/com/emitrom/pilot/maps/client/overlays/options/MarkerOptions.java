...
public class MarkerOptions extends AbstractOption {
    ...
    public native void setIcon(MarkerImage value)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		jso.icon = value.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
    }-*/;
    ...
    public native void setPosition(LatLng value)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		this.position = value.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
    }-*/;
    ...
    public native void setShadow(MarkerImage value)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		this.shadow = value.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		;
    }-*/;
