...
public class InfoWindow extends MVCObject {
    ...
    public  native void open(GMap map, MVCObject anchor)/*-{
		...
		jso
				.open(
						map.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()(),
						anchor.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    }-*/;

    public  native void open(GMap map)/*-{
		var jso = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		jso
				.open(map.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    }-*/;
