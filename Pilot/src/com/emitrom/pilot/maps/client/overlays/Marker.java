...
public class Marker extends MVCObject {
	...
	public final native void setIcon(MarkerImage value)/*-{
		var jso = this.@com.pilot.shared.client.core.JsObject::getJsObj()();
		jso
				.setIcon(value.@com.pilot.shared.client.core.JsObject::getJsObj()());
	}-*/;
	...
	public final native void setShadow(MarkerImage value)/*-{
		var jso = this.@com.pilot.shared.client.core.JsObject::getJsObj()();
		jso
				.setShadow(value.@com.pilot.shared.client.core.JsObject::getJsObj()());
	}-*/;
	...
	public final native void setShape(MarkerShape value)/*-{
		var jso = this.@com.pilot.shared.client.core.JsObject::getJsObj()();
		jso
				.setShape(value.@com.pilot.shared.client.core.JsObject::getJsObj()());
	}-*/;
