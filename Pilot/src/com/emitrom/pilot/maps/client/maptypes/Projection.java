...
public class Projection extends JsObject {
    ...
    public native Point fromLatLgnToPoint(LatLng latLgn, Point point)/*-{
		...
		var obj = jso
				.fromLatLgnToPoint(
						latLgn.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()(),
						point.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
    ...
    public native LatLng fromPointToLatLgn(Point point)/*-{
		var jso = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		var obj = jso
				.fromPointToLatLgn(point.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()());
