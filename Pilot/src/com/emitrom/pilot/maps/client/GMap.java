...
public class GMap extends MVCObject {
    ...
    public final native void setCenter(LatLng latLgn)/*-{
		var jso = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		var latln = latLgn.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		jso.setCenter(latln);
    }-*/;
    ...
    /**
     * For now, the Google Maps JavaScript API will render maps with the classic
     * look and feel by default. If you wish to opt-in to the new visual refresh
     * mode, set this property to true.
     * <p>
     * <b>Note</b> : You must enable this property before the map is rendered.
     * 
     * @param value
     *            , true to use the new Google Maps visual effect
     */
    public static native void setVisualRefresh(boolean value)/*-{
		$wnd.google.maps.visualRefresh = value;
    }-*/;

    private static native void addEventListener(JavaScriptObject target, String event, MapTapHandler handler)/*-{
    ...
    private static native void addEventListener(JavaScriptObject target, String event, DragEndHandler handler)/*-{
		$wnd.google.maps.event
				.addListener(
						target,
						event,
