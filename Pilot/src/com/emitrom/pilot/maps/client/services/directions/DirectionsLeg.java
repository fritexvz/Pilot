...
public class DirectionsLeg extends JsObject {
    ...
    public native void setDuration(Duration value)/*-{
		var jso = this.@com.pilot.shared.client.core.JsObject::getJsObj()();
		this.duration = value.@com.pilot.shared.client.core.JsObject::getJsObj()();
    }-*/;
    ...
    public native void setEndLocation(LatLng value)/*-{
		var jso = this.@com.pilot.shared.client.core.JsObject::getJsObj()();
		jso.end_location = value.@com.pilot.shared.client.core.JsObject::getJsObj()();
		;
    }-*/;
    ...
    public native void setStartLocation(LatLng value)/*-{
		var jso = this.@com.pilot.shared.client.core.JsObject::getJsObj()();
		jso.start_location = value.@com.pilot.shared.client.core.JsObject::getJsObj()();
		;
    }-*/;
