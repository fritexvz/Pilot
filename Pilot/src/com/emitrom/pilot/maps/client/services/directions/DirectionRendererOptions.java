...
public class DirectionRendererOptions extends JsObject {
    ...
    public native void setDirections(DirectionsResult value)/*-{
		...
		jso.directions = value.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		;
    }-*/;
    ...
    public native void setInfoWindow(InfoWindow value)/*-{
		var jso = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		jso.infoWindow = value.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		;
    }-*/;
    ...
    public native void setMarkerOptions(MarkerOptions value)/*-{
		var jso = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		jso.markerOptions = value.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
    }-*/;
    ...
    public native void setPolylineOptions(PolylineOptions value)/*-{
		var jso = this.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
		jso.polylineOptions = value.@com.emitrom.pilot.core.shared.client.core.JsObject::getJsObj()();
    }-*/;
