...
public class StreetViewPanoramaOptions extends JsObject {
    ...
    public native void setAddressControlOptions(StreetViewAddressContropOptions options)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		jso.addressControlOptions = options.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
    }-*/;
    ...
    public native void setPanControlOptions(PanControlOptions options)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		this.panControlOptions = options.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		;
    }-*/;
    ...
    public native void setPosition(LatLng value)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		jso.position = value.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		;
    }-*/;
    ...
    public native void setPov(StreetViewPov value)/*-{
		var jso = this.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
		jso.pov = value.@com.emitrom.pilot.util.client.core.JsObject::getJsObj()();
    }-*/;
